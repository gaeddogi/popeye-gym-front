...
.background-image {
    background-image:url('@/assets/images/popeye.png');
...
/* .button--naver .icon {
  border-right: 1px solid #03a74d;
}
.button--naver .icon:after {
  border-right: 1px solid #5dae81;
} */
.button--naver:hover {
...
/* .button--kakao .icon {
  border-right: 1px solid #03c75b;
} */
/* .button--kakao .icon:after {
  border-right: 1px solid #5dae81;
} */
.button--kakao:hover {
